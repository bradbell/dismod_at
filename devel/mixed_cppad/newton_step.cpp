...
The routine $cref/pack(theta, u)/mixed_cppad_pack/$$ is used to
...
$children%example/devel/mixed_cppad/private/newton_step_xam.cpp
%$$
$head Example$$
...
{	assert( atom_fun_ == DISMOD_AT_NULL_PTR );
	...
	const char* name = "mixed_cppad newton_step";
