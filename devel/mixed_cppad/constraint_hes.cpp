...
$section mixed_cppad: Hessian of Prior for Fixed Effects$$
...
components of the $cref/constraint/mixed_cppad_constraint/$$.
...
$children%
	example/devel/mixed_cppad/private/constraint_hes_xam.cpp
%$$
$head Example$$
...
void mixed_cppad::constraint_hes(
	...
	d_vector&              val_out     )
{
	...
	{	std::string error_message =
		"mixed_cppad::initialize was not called before constraint_hes";
