...
corresponding to the $cref/fix_like/mixed_cppad_fix_like/$$.
It has the same size as the corresponding return value
$cref/vec/mixed_cppad_fix_like/vec/$$.
...
$children%
	example/devel/mixed_cppad/private/fix_like_hes_xam.cpp
%$$
$head Example$$
