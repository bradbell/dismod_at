...
/*
$begin mixed_cppad_constraint_jac$$
$spell
	cppad
	eval
	vec
...
$children%
	example/devel/mixed_cppad/private/constraint_jac_xam.cpp
%$$
$head Example$$
...
void mixed_cppad::constraint_jac(
	...
	d_vector&              val_out     )
{
	...
	{	std::string error_message =
		"mixed_cppad::initialize was not called before constraint_jac";
