...
/*
$begin cppad_mixed_ran_like_hes$$
$spell
	cppad
	hes
	vec
...
$head hes_ran_row_$$
This $code cppad_mixed$$ member variable has prototype
$codei%
...
$children%
	example/devel/cppad_mixed/private/ran_like_hes_xam.cpp
%$$
$head Example$$
