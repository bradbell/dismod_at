...
/*
$begin cppad_mixed_record_constraint$$
$spell
	cppad
	jac
	vec
...
$section cppad_mixed: Record Prior The Constraint Function$$
...
$cref/constraint/cppad_mixed_constraint/$$ function $latex c( \theta )$$.
...
void cppad_mixed::record_constraint(const d_vector& fixed_vec  )
