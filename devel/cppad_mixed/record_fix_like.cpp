...
/*
$begin cppad_mixed_record_fix_like$$
$spell
	cppad
	jac
	vec
...
$section cppad_mixed: Record Fixed Negative Log-Likelihood For Fixed Effects$$
...
void cppad_mixed::record_fix_like(const d_vector& fixed_vec  )
