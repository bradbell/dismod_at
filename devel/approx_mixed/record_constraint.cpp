...
/*
$begin approx_mixed_record_constraint$$
$spell
	jac
	vec
	const
...
$section approx_mixed: Record Prior The Constraint Function$$
...
$cref/constraint/approx_mixed_constraint/$$ function $latex c( \theta )$$.
