...
$head database$$
Is an
$href%http://www.sqlite.org/sqlite/%$$ data base contianing the
...
then  it specifies the the parent
...
$head tolerance$$
is the disired relative convergence tolerance (requested of Ipopt).
