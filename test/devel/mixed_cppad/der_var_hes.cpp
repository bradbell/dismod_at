...
$section C++ mixed_cppad: Derivative Test where Hessian Depends on Random Effects$$
...
$head Theory$$
See the $tref mixed_cppad_new_theory$$ section for the
...
$code
$verbatim%example/devel/mixed_cppad/user/der_var_hes.cpp
	%0%// BEGIN C++%// END C++%1%$$
$$
