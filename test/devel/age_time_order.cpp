...
test_smooth_info(void)
{
	...
	"create table smooth_grid("
		...
		" const_value    real)",
	"insert into smooth_grid values(0,  0,  0,  0,  1,       2, null, null)",
	"insert into smooth_grid values(2,  0,  2,  0,  3,    null, null, null)",
	"insert into smooth_grid values(1,  0,  3,  0,  2,       3, null, null)",
	"insert into smooth_grid values(3,  0,  0,  1,  5,       6,    7, null)",
	"insert into smooth_grid values(5,  0,  2,  1,  1,    null,    3, null)",
	"insert into smooth_grid values(4,  0,  3,  1,  null,    8,    9, 10.0)",
	};
	...
	ok  &= s_info.value_prior_id(1, 0) ==  DISMOD_AT_NULL_SIZE_T;
