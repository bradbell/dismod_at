...
$section C++ mixed_cppad: Random Effects Variance May Cause Data Mismatch$$
...
$head Theory$$
See the $tref mixed_cppad_theory$$ section for the
...
$code
$verbatim%example/devel/mixed_cppad/user/data_mismatch_xam.cpp
	%0%// BEGIN C++%// END C++%1%$$
$$
