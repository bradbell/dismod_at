...
$section C++ ran_obj_hes_fix: Example and Test$$
...
$code
$verbatim%example/devel/approx_mixed/private/ran_obj_hes_fix_xam.cpp
	%0%// BEGIN C++%// END C++%1%$$
$$
...
bool ran_obj_hes_fix_xam(void)
{
	...
	vector<double> val;
	approx_object.ran_obj_hes_fix(fixed_vec, random_vec, row, col, val);
