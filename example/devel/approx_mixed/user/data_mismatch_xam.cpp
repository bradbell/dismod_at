...
$section C++ approx_mixed: Random Effects Variance May Cause Data Mismatch$$
...
$head Theory$$
See the $tref approx_mixed_theory$$ section for the
...
$code
$verbatim%example/devel/approx_mixed/user/data_mismatch_xam.cpp
	%0%// BEGIN C++%// END C++%1%$$
$$
...
bool data_mismatch_xam(void)
{
	...
	double L_theta_in = approx_object.L_theta(theta_in, u_in);
