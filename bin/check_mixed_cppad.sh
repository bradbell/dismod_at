...
# ---------------------------------------------------------------------------
if [ ! -e 'bin/check_mixed_cppad.sh' ]
then
	echo 'bin/check_mixed_cppad.sh: must be executed from its parent directory'
	exit 1
fi
include_file="$HOME/prefix/dismod_at/include/dismod_at/mixed_cppad.hpp"
library_file="$HOME/prefix/dismod_at/lib64/libmixed_cppad.a"
example_file="example/devel/mixed_cppad/user/no_random_xam.cpp"
