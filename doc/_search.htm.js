...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20210729: User Documentation and API', other:' purpose links' },
...
{ tag: 'sim_data', title:'Simulate One Dismod_at Data Value', other:' under construction syntax purpose rate integrand_name grid age time noise density_name meas_std eta nu restriction abs_tol meas_value example' },
{ tag: 'user_sim_data.py', title:'Using the Python sim_data Utility', other:' see also random effects priors simulation model ode_step_size source code' },
