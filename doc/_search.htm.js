...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20210617: User Documentation and API', other:' purpose links' },
...
{ tag: 'option_table', title:'The Option Table', other:' format option_id option_name option_value default changing values parent node parent_node_id parent_node_name children data subset avgint zero sum constraints zero_sum_child_rate zero_sum_mulcov_group extra columns data_extra_columns avgint_extra_columns age average grid ode_step_size age_avg_split rate_case no_ode iota_zero_rho_zero iota_pos_rho_zero iota_zero_rho_pos iota_pos_rho_pos compress intervals compress_integrand compress_age_size compress_time_size optimize fixed random derivative_test max_num_iter print_level accept_after_max_steps tolerance only quasi_fixed bound_frac_fixed limited_memory_max_history_fixed method_random bound_random meas_noise_effect warn_on_stderr minimum_meas_cv hold_out_integrand random_seed example' },
...
{ tag: 'fit_command', title:'The Fit Command', other:' syntax database variables fixed random both simulate_index data_sim_table prior_sim_table warm_start ipopt_info_table fit_var_table fit_data_subset_table trace_fixed mixed_info hold_out effects convergence problems options example' },
...
{ tag: 'whats_new_2021', title:'Changes and Additions to Dismod_at During 2021', other:' 06-17 06-15 06-14 06-13 06-12 06-11 06-10 06-09 06-08 06-07 06-06 06-01 05-31 05-29 05-21 05-20 05-19 05-18 05-15 05-07 05-06 04-16 03-02 01-28 01-22 01-21 01-19 01-11 01-10 01-09 01-08' },
