...
'user_fit_gamma.py  Fitting Data Standard Deviations, Gamma  ',' random effects iota other rates covariate multiplier meas_std_effect ',
...
'option_table  The Option Table  ',' conventions changing values option_id option_name option_value parent_node_id parent_node_name default children data subset avgint meas_std_effect zero_sum_random data_extra_columns avgint_extra_columns warn_on_stderr minimum_meas_cv ode_step_size age_avg_split average grid random_seed rate_case iota_zero_rho_zero iota_pos_rho_zero iota_zero_rho_pos iota_pos_rho_pos fixed derivative_test max_num_iter print_level accept_after_max_steps tolerance only quasi_fixed bound_frac_fixed limited_memory_max_history_fixed bound_random example ',
...
'data_like  Data Likelihood and Weighted Residuals  ',' table notation y_i a_i b_i s_i t_i d_i i_i x_ij w_i delta_i measurement standard deviation covariates k_i gamma_j effects theta average integrand adjusted scaling add variance add_std_scale_all add_std_scale_log add_var_scale_all add_var_scale_log ',
...
'avg_std_effect_ctor  Constructing An Average Standard Deviation Effect Object  ',' syntax prototype ode_step_size age_avg_grid age_table time_table integrand_table w_info_vec s_info_vec pack_object example ',
