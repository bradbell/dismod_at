...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20210608: User Documentation and API', other:' purpose links' },
...
{ tag: 'run_cmake.sh', title:'bin/run_cmake.sh: User Configuration Options', other:' verbose_makefile build_type dismod_at_prefix debug release python3_executable choosing c++ compiler extra_cxx_flags cmake_libdir system_specific_library_list' },
...
{ tag: 'user_data_sim.py', title:'Explanation of Simulated Data Table, data_sim', other:' see also purpose random effects priors iota other rates covariate multiplier subset meas_noise_effect notation before simulation delta sigma z delta_hat source code' },
...
{ tag: 'user_residual.py', title:'Weighted Residuals', other:' example parameters model data delta gaussian log-gaussian priors value difference source code' },
{ tag: 'user_sample_simple.py', title:'Simple Sampling From The Posterior Distribution', other:' purpose discussion variance source code' },
...
{ tag: 'user_sim_log.py', title:'Simulating Data with Log Transformed Distribution', other:' see also example parameters model covariate multiplier notation adjusted standard deviation simulations source code' },
...
{ tag: 'data_table', title:'The Data Table', other:' discussion data_id data_name integrand_id density_id nonsmooth node_id parent child subgroup_id weight_id null hold_out meas_value meas_std adjusted standard deviation delta linear scaling log eta age_lower age_upper time_lower time_upper covariates example' },
...
{ tag: 'option_table', title:'The Option Table', other:' discussion conventions changing values option_id option_name option_value parent_node_id default parent_node_name children data subset avgint meas_noise_effect zero_sum_child_rate zero_sum_mulcov_group data_extra_columns avgint_extra_columns warn_on_stderr minimum_meas_cv ode_step_size age_avg_split average grid random_seed rate_case no_ode iota_zero_rho_zero iota_pos_rho_zero iota_zero_rho_pos iota_pos_rho_pos fixed derivative_test max_num_iter print_level accept_after_max_steps tolerance only quasi_fixed bound_frac_fixed limited_memory_max_history_fixed method_random bound_random example' },
...
{ tag: 'fixed_trace_table', title:'The Fixed Effects Optimization Trace Table', other:' discussion fixed_trace_id iter obj_value inf_pr inf_du mu d_norm regularization_size alpha_du alpha_pr ls_trials restoration reference' },
...
{ tag: 'data_like', title:'Data Likelihood and Weighted Residuals', other:' notation a_i b_i d_i i_i s_i t_i w_i x_ij y_i minimum cv standard deviation delta_i fixed effects theta random average integrand a_i(u theta) measurement noise covariates k_i gamma_j (a t) e_i(theta) adjusted delta_i(theta) scaling add variance add_std_scale_all add_std_scale_none add_std_scale_log add_var_scale_all add_var_scale_none add_var_scale_log transformed sigma_i(theta)' },
...
{ tag: 'statistic', title:'Some Statistical Function Definitions', other:' notation y z mu sigma eta nu weighted residual value difference log-density uniform gaussian censored log-gaussian laplace log-laplace student\'s-t log-student\'s-t' },
...
{ tag: 'fit_command', title:'The Fit Command', other:' syntax database variables fixed random both simulate_index data_sim_table prior_sim_table warm_start ipopt_info fit_var_table fit_data_subset_table effects convergence problems options example' },
...
{ tag: 'db2csv_command', title:'Create Csv Files that Summarize The Database', other:' syntax program python function convention dir fit_var fit_data_subset simulate_index option.csv log.csv age_avg.csv hes_fixed.csv hes_random.csv fixed_trace.csv variable.csv var_id var_type s_id m_id time rate integrand covariate node group subgroup depend start scale fit_value truth sam_avg sam_std res_value res_dage res_dtime lag_value lag_dage lag_dtime sim_v sim_a sim_t prior_info data.csv data_id data_extra_columns child weight age_lo age_up time_lo time_up out density eta nu meas_std meas_stdcv meas_delta meas_value avgint residual sim_value covariates predict.csv avgint_id avgint_extra_columns s_index example ihme_db.sh' },
...
{ tag: 'whats_new_2021', title:'Changes and Additions to Dismod_at During 2021', other:' 06-08 06-07 06-06 06-01 05-31 05-29 05-21 05-20 05-19 05-18 05-15 05-07 05-06 04-16 03-02 01-28 01-22 01-21 01-19 01-11 01-10 01-09 01-08' },
...
{ tag: 'wish_list', title:'Dismod_at Wish List', other:' tracing optimization speed log density bound constraints laplace random effect immunity simulating priors warm starting optimizer multi-threading user examples meas_std lagrange multipliers censored create_database ode solution prevalence large excess mortality rate_case command diagrams real world point windows install' }
]
