...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20211106: User Documentation and API', other:' purpose links' },
...
{ tag: 'user_plot_data_fit.py', title:'Case with no Children; i.e., no Random Effects', other:' nodes rates integrands n_data measurement noise hold_out call to source code' },
...
{ tag: 'plot_data_fit', title:'Plot The Data Fit By Integrand', other:' syntax database integrand_list pdf_file n_fit_list legend table hold out point symbol plus green red black example' },
