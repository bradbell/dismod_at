...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20211205: User Documentation and API', other:' purpose links' },
...
{ tag: 'user_plot_data_fit.py', title:'Case with no Children; i.e., no Random Effects', other:' nodes rates integrands n_data max_plot measurement noise hold_out call to source code' },
{ tag: 'user_plot_rate_fit.py', title:'Case with no Children; i.e., no Random Effects', other:' nodes rates integrands data call to source code' },
...
{ tag: 'plot_curve', title:'Plot A Value With Respect To Age and Time', other:' syntax pdf_file plot_title plot_limit age_min age_max time_min time_max plot_data std example' },
{ tag: 'plot_data_fit', title:'Plot The Data Fit By Integrand', other:' syntax database pdf_file integrand_list plot_title max_plot n_fit_dict legend table hold out point symbol plus green red black example' },
{ tag: 'plot_rate_fit', title:'Plot The Rates for a Fit', other:' syntax database rate_set pdf_file plot_title plot_set example' },
...
{ tag: 'system_command_prc', title:'Print Run and Check a System Command', other:' syntax purpose print_command return_stdout return_stderr result example' },
