...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20201217: User Documentation and API', other:' purpose links' },
...
{ tag: 'user_sum_residual.py', title:'Sum of Residuals at Optimal Estimate', other:' problem solution weighted cv standard deviations average' },
...
{ tag: 'wish_list', title:'Dismod_at Wish List', other:' bound constraints random effect immunity simulating priors warm starting optimizer multi-threading user examples meas_std lagrange multipliers censored laplace create_database ode solution prevalence large excess mortality conditionals checkpointing command diagrams real world tracing optimization windows install' }
]
