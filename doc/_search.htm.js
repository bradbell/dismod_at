...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20191025: User Documentation and API', other:' purpose links' },
...
{ tag: 'dock_dismod_at.sh', title:'Install and Run dismod_at in a Docker Image', other:' syntax logging output purpose requirements building images version dismod_at.base dismod_at.image removing containers dockerfile errors new build_type other arguments debugging determine id start stop' },
...
{ tag: 'user_fit_gamma.py', title:'Fitting Measurement Noise Covariate Multipliers, Gamma', other:' random effects iota other rates data meas_noise_effect scaling source code' },
...
{ tag: 'avgint_table', title:'The avgint Table: Defines Average Integrand Cases', other:' see also purpose usage parent rates child avgint_id integrand_id node_id weight_id null age_lower age_upper time_lower time_upper covariates example' },
...
{ tag: 'data_table', title:'The Data Table', other:' data_id data_name integrand_id density_id nonsmooth node_id parent random effects child weight_id null hold_out meas_value meas_std adjusted standard deviation delta linear scaling log eta age_lower age_upper time_lower time_upper covariates example' },
...
{ tag: 'mulcov_table', title:'The mulcov Table: Covariate Multipliers', other:' mulcov_id mulcov_type rate_value meas_value meas_noise meas_std: deprecated 2019-04-07 rate_id integrand_id covariate_id smooth_id null pini example' },
{ tag: 'mulcov_table.py', title:'mulcov_table: Example and Test', other:'' },
{ tag: 'node_table', title:'The Node Table', other:' node_id node_name parent child group descendant example' },
...
{ tag: 'var_table', title:'Identifying Model Variables', other:' var_id var_type mulstd_value mulstd_dage mulstd_dtime rate mulcov_rate_value mulcov_meas_value mulcov_meas_noise smooth_id age_id time_id node_id rate_id integrand_id covariate_id mulcov_id example' },
...
{ tag: 'prior_sim_table', title:'Simulated Variation in Prior', other:' discussion prior_sim_id simulate_index var_id prior_sim_value zero_sum_random prior_sim_dage prior_sim_dtime censoring example' },
...
{ tag: 'model_variables', title:'The Model Variables', other:' introduction function age time smoothing interpolation children fixed effects theta standard deviation multipliers lambda parent rates covariate random variation initial prevalence other groups' },
...
{ tag: 'fixed_value', title:'The Fixed Effects Value Density Function', other:' theta_j prior_id lambda_j mu_j delta_j d_j v_j v^theta' },
{ tag: 'fixed_diff', title:'Fixed Effects Differences Density Function', other:' k i(k) j(k) lambda_k theta_ijk mu_ijk delta_ijk d_ijk age a^theta time t^theta' },
...
{ tag: 'random_value', title:'The Random Effects Value Density Function', other:' j k_j a_j t_j u_cj lambda_j delta_j d_j mu_j v_cj^u v^u' },
{ tag: 'random_diff', title:'Random Effects Difference Density Function', other:' k i(k) j(k) lambda_k u_ijkc delta_ijk d_ijk mu_ijk age differences a^u time t^u' },
...
{ tag: 'depend_command.py', title:'fit Command: Example and Test', other:'' },
...
{ tag: 'old2new_command', title:'Convert an Old Database to New Format', other:' syntax discussion var table' },
...
{ tag: 'set_command.py', title:'variable Command: Example and Test', other:' truth_var table' },
...
{ tag: 'db2csv_command.py', title:'init Command: Example and Test', other:'' },
...
{ tag: 'modify_command.py', title:'init Command: Example and Test', other:'' },
...
{ tag: 'wish_list', title:'Dismod_at Wish List', other:' multi-threading asymptotic statistics more random effects covariate multipliers data partitions user examples meas_std lagrange censored laplace create_database ode solution prevalence large excess mortality conditionals checkpointing command diagrams real world starting tracing optimization windows install' }
]
