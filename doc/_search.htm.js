...
'install_unix  Installing dismod_at in Unix  ',' download system requirements c++ compiler fortran cmake pkg-config python3 sqlite3 gsl special run_cmake.sh libdir.sh eigen ipopt suitesparse cppad cppad_mixed setup build_type command test executable path example ',
...
'data_table  The Data Table  ',' data_id data_name integrand_id density_id node_id parent random effects child weight_id hold_out meas_value meas_std eta null age_lower age_upper time_lower time_upper covariates example ',
...
'integrand_table  The Integrand Table  ',' integrand_id integrand_name sincidence remission mtexcess mtother mtwith susceptible withc prevalence tincidence mtspecific mtall mtstandard relrisk example ',
...
'ode_grid  The dismod_at Ode Grid  ',' delta a_min a_max t_min t_max number age points a_i time t_j ',
...
'get_density_table  C++: Get the Density Table Information  ',' syntax purpose db density_enum example ',
...
'a2_double  a2_double  ',' syntax purpose source code ',
...
'fit_model_ctor  Fit Model Constructor  ',' syntax fit_object db bound_random fit_or_sample pack_object start_var prior_table s_info_vec data_object prior_object quasi_fixed zero_sum_random prototype ',
...
'whats_new_2017  Changes and Additions to Dismod_at During 2017  ',' 11-12 11-08 10-25 10-24 10-22 10-21 10-20 10-18 10-17 10-14 10-13 10-09 10-06 10-05 10-04 10-02 10-01 09-30 09-29 09-28 09-27 09-26 09-25 09-23 09-21 09-20 09-19 09-18 09-17 09-16 09-02 09-01 08-30 08-07 05-23 05-05 05-02 05-01 04-29 04-27 04-26 04-25 04-24 04-23 04-22 04-21 04-20 04-19 04-18 04-17 04-16 04-15 04-09 04-07 04-05 04-04 04-03 04-01 03-30 03-29 03-17 03-06 03-04 03-03 01-27 01-26 01-24 01-14 01-15 ',
...
'wish_list  Dismod_at Wish List  ',' parent_node simulated data lagrange multipliers solution step size large excess mortality conditionals checkpointing reduce number solutions documentation real world example user examples model simulating sampling random effects special hessian starting tracing optimization windows install '
]
