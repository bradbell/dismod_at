...
{ tag: 'wish_list', title:'Dismod_at Wish List', other:' multi-threading asymptotic statistics user examples meas_std lagrange multipliers censored laplace create_database ode solution prevalence large excess mortality conditionals checkpointing command diagrams real world random starting tracing optimization windows install' }
]
