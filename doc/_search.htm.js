...
Keyword = 
[
{ tag: 'dismod_at', title:'dismod_at-20210606: User Documentation and API', other:' purpose links' },
...
{ tag: 'option_table', title:'The Option Table', other:' conventions changing values option_id option_name option_value parent_node_id default parent_node_name children data subset avgint meas_noise_effect zero_sum_child_rate zero_sum_mulcov_group data_extra_columns avgint_extra_columns warn_on_stderr minimum_meas_cv ode_step_size age_avg_split average grid random_seed rate_case no_ode iota_zero_rho_zero iota_pos_rho_zero iota_zero_rho_pos iota_pos_rho_pos fixed derivative_test max_num_iter print_level accept_after_max_steps tolerance only quasi_fixed bound_frac_fixed limited_memory_max_history_fixed method_random bound_random example' },
...
{ tag: 'data_flow', title:'The Dismod_at Data Flow', other:' output tables name command init extra input' },
...
{ tag: 'data_sim_table', title:'Simulated Measurements and Adjusted Standard Deviations', other:' data_sim_id simulate_index data_subset_id data_sim_value method data_id y delta eta sigma z example' },
...
{ tag: 'fixed_trace_table', title:'The Fixed Effects Optimization Trace Table', other:' fixed_trace_id iter obj_value inf_pr inf_du mu d_norm regularization_size alpha_du alpha_pr ls_trials reference' },
...
{ tag: 'whats_new_2021', title:'Changes and Additions to Dismod_at During 2021', other:' 06-06 06-01 05-31 05-29 05-21 05-20 05-19 05-18 05-15 05-07 05-06 04-16 03-02 01-28 01-22 01-21 01-19 01-11 01-10 01-09 01-08' },
