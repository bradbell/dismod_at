...
Keyword = 
[
'dismod_at  Disease Rates as Functions of Age and Time: dismod_at-20181021  ',' ',
...
'user  User Examples and Tests  ',' see also run one user_speed.py example.db ',
...
'user_fit_sim.py  Fitting Simulated Data Example  ',' parent iota child other rates covariate multiplier ',
'avg_age_split.py  Non-uniform Average Age Grid  ',' purpose variables prior data fit predict ode_step_size source ',
...
'user_speed.py  A Simulate Data Speed Test  ',' syntax python3 random_seed n_children quasi_fixed ode_step_size ',
...
'option_table  The Option Table  ',' conventions changing values option_id option_name option_value parent_node_id parent_node_name default children data subset avgint zero_sum_random data_extra_columns avgint_extra_columns warn_on_stderr minimum_meas_cv ode_step_size avg_age_split average grid random_seed rate_case iota_zero_rho_zero iota_pos_rho_zero iota_zero_rho_pos iota_pos_rho_pos fixed derivative_test max_num_iter print_level accept_after_max_steps tolerance only quasi_fixed bound_frac_fixed limited_memory_max_history_fixed bound_random example ',
...
'numeric_average  Numerical Approximation of Average Integrands  ',' standard deviation effect ode initial rectangle a_l a_u t_l t_u time step delta grid extended cohort solution line s_j lower cohorts upper refinement not required w(a t) g(a integration ',
'command  The dismod_at Commands  ',' data flow log messages ',
'set_command  Directly Setting Table Values  ',' syntax database option name init table_out start_var scale_var truth_var source sample prior_mean fit_var example ',
...
'avg_age_grid  Split the Average Age Grid  ',' syntax prototype ode_step_size avg_age_split age_table example ',
'avg_age_grid_xam.cpp  C++ avg_age_grid: Example and Test  ',' ',
...
'pack_info_mulstd  Devel Pack Variables: Standard Deviations Multipliers  ',' syntax pack_object smooth_id offset example ',
...
'avg_integrand_ctor  Constructing An Average Integrand Object  ',' syntax prototype ode_step_size rate_case avg_age_grid age_table time_table integrand_table w_info_vec s_info_vec pack_object example ',
...
'devel_avg_std_effect  Computing Average Standard Deviation Effect  ',' ',
'avg_std_effect_ctor  Constructing An Average Standard Deviation Effect Object  ',' syntax prototype ode_step_size avg_age_grid age_table time_table integrand_table w_info_vec s_info_vec pack_object example ',
'avg_std_effect_rectangle  Computing One Average Integrand  ',' syntax prototype age_lower age_upper time_lower time_upper weight_id integrand_id float pack_vec example ',
'avg_std_effect_xam.cpp  C++ avg_std_effect: Example and Test  ',' ',
'whats_new_2018  Changes and Additions to Dismod_at During 2018  ',' 10-21 10-13 10-05 09-30 09-28 09-24 09-14 08-30 08-29 08-22 08-13 08-09 08-08 08-07 08-06 07-31 07-30 07-27 07-26 api other 07-25 07-23 07-21 07-13 06-30 06-29 06-21 06-20 06-18 06-14 06-09 06-04 05-24 05-23 05-21 05-14 05-09 05-08 05-07 05-05 05-04 05-02 04-30 04-26 04-25 04-24 04-23 04-22 04-21 04-16 04-13 04-12 04-11 04-10 04-09 04-08 04-07 04-06 03-21 03-13 03-10 03-08 03-06 02-20 02-17 02-14 02-13 02-12 02-11 02-09 02-08 02-05 02-04 02-03 02-02 02-01 01-31 01-30 01-28 01-26 01-25 01-24 01-23 01-22 01-21 01-20 01-18 01-16 01-12 01-09 ',
...
'wish_list  Dismod_at Wish List  ',' ode solution step size example minimum time age-time intervals prevalence large excess mortality csv2db command covariate multipliers random effects grids value priors difference sample conditionals checkpointing meas_std diagrams lagrange documentation real world user examples model sampling special hessian starting tracing optimization windows install '
]
