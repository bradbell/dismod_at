...
var list_current0 = [
'get_smooth_table.htm#Syntax',
'get_smooth_table.htm#Purpose',
'get_smooth_table.htm#db',
'get_smooth_table.htm#smooth_table',
'get_smooth_table.htm#smooth_struct',
'get_smooth_table.htm#Example'
];
