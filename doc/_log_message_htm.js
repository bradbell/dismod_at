...
var list_current0 = [
'log_message.htm#Syntax',
'log_message.htm#db',
'log_message.htm#os',
'log_message.htm#message_type',
'log_message.htm#message',
'log_message.htm#table_name',
'log_message.htm#row_id',
'log_message.htm#unix_time',
'log_message.htm#Example'
];
var list_down3 = [
'intro_math.htm',
'install_unix.htm',
